...
jso_configure({
	"uvicate": {
		client_id: "Uep",
		redirect_uri: "http://victor/Desarrollos/ERP/Uep/",
		authorization: "http://victor/Desarrollos/ERP/ERP/oauth/2/login.php",
		isDefault: true
	}
});
...
(function(){
	...
	Main.prototype.start = function(r) {
		...
		var j = {name: 'uVicate Enterprise Planning', modules:modules, div:'#content', currentLang: lang};
